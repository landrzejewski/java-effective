...
public final class Mod013SwitchExpressions {

    private Mod013SwitchExpressions() {}
    ...
    */
    static void switchExpression() {
        ...
        for (int code : codes) {
            ...
            System.out.printf(Locale.ROOT, "  %3d -> %s%n", code, family);
        }
    }
    ...
    */
    static void yieldInBlocks() {
        ...
        for (int code : new int[]{ 204, 418, 503 }) {
            ...
            System.out.printf(Locale.ROOT, "  %d -> %s%n", code, description);
        }
    }
    ...
    Sealed types (Mod015) get the same compiler-enforced exhaustiveness.
    */
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Mod013SwitchExpressions finished");
    }
}
