...
public final class Mod002BuiltInFunctionalInterfaces {
    ...
    */
    ...
    - For int, long and double, java.util.function provides a full family of "specialized" interfaces that take or
      return the primitive unboxed:
      - IntPredicate, IntFunction<R>, IntUnaryOperator, IntBinaryOperator.
      - ToIntFunction<T>, IntToLongFunction, IntToDoubleFunction.
      boolean is the exception: the only boolean specialization is BooleanSupplier. There is no BooleanFunction,
      no BooleanUnaryOperator — a boolean-taking function is just Predicate<T>.
